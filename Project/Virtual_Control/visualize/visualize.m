...
%%
function visualize(q, dq, r0, parameters, step_number, t)
    ...
    dX = alpha.*F;
    quiver(x_h, z_h, dX(1), dX(2),0)
    quiver(x_swf, z_swf, dX(3), dX(4),0 )
    quiver(x_t, z_t, dX(5), dX(6),0 )
